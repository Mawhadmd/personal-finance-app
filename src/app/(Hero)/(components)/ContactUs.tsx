...
export default function ContactUs() {
  return (
    <div className='flex justify-around items-center p-10' id='contact'>
        <div>
        ...
        <form className='flex flex-col max-w-md'>
            ...
            <input type="text" className='p-2 mb-4 border rounded' placeholder='Your Name' required />
            <label className='mb-2'>Email:</label>
            <input type="email" className='p-2 mb-4 border rounded' placeholder='Your Email' required />
            <label className='mb-2'>Message:</label>
            <textarea className='p-2 mb-4 border rounded' placeholder='Your Message' rows={4} required></textarea>
